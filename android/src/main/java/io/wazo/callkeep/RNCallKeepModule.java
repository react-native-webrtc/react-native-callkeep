 ...
 */
 ...
 public class RNCallKeepModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
     ...
     private static String[] permissions = {Build.VERSION.SDK_INT < 30 ? Manifest.permission.READ_PHONE_STATE : Manifest.permission.READ_PHONE_NUMBERS, Manifest.permission.CALL_PHONE, Manifest.permission.RECORD_AUDIO};
     ...
     public void checkPhoneAccountPermission(ReadableArray optionalPermissions, Promise promise) {
         ...
         if (!this.hasPermissions()) {
             ...
             this.reactContext.getNativeModule(PermissionsModule.class).requestMultiplePermissions(allPermissionaw, new Promise() {
                 @Override
                 public void resolve(@Nullable Object value) {
                     ...
                     for (int i = 0; i < allPermissions.length; ++i) {
                         ...
                         grantedResult[i] = grantedPermission.getString(perm).equals("granted") ? PackageManager.PERMISSION_GRANTED : PackageManager.PERMISSION_DENIED;
                     }
     ...
     public void setMutedCall(String uuid, boolean shouldMute) {
         ...
         if (shouldMute) {
             ...
             newAudioState = new CallAudioState(false, conn.getCallAudioState().getRoute(), conn.getCallAudioState().getSupportedRouteMask());
         }
     ...
     public void backToForeground() {
         ...
         if (isOpened) {
             ...
             focusIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK + WindowManager.LayoutParams.FLAG_SHOW_WHEN_LOCKED + WindowManager.LayoutParams.FLAG_DISMISS_KEYGUARD + WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON);
     ...
     private boolean hasPhoneAccount() {
         ...
         return isConnectionServiceAvailable() && telecomManager != null && hasPermissions() && telecomManager.getPhoneAccount(handle) != null && telecomManager.getPhoneAccount(handle).isEnabled();
     }
